...
public abstract class PostgresIntegrationTest {
	...
	static void datasourceProperties(DynamicPropertyRegistry registry) {
		...
		// Clip test ghi vao temp dir cua may, khong do vao ./var/clips cua repo.
		registry.add("app.clip-storage-path", () -> CLIP_ROOT.toString());
	}

	protected static final java.nio.file.Path CLIP_ROOT = createTempClipRoot();

	private static java.nio.file.Path createTempClipRoot() {
		try {
			return java.nio.file.Files.createTempDirectory("fitness-clips-test");
